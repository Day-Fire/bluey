Shader "Hidden/Tint"
{
        ...
        SubShader
    {
        ...
        CGINCLUDE
            ...
            float _Depth, _Strength, _CutoffDistance;
         ...
         Pass {
                ...
                float4 fp(v2f i) : SV_Target {
                    ...
                    float depth = min(1, pow(Linear01Depth(SAMPLE_DEPTH_TEXTURE(_CameraDepthTexture, i.uv)) + _Depth, _Strength));
                    ...
                    if (depth > 0.3) {
                        ...
                        return saturate(output / output.w); //kuwa
                    }
                    return tex2D(_MainTex, i.uv);
                    //return vector(depth,depth,depth, 1);
                }
                ENDCG
            }
